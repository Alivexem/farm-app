...
const Buybody = () => {
  return (
    <div>
      ...
      <div className='relative left-36 pl-5 pr-4 mt-8 md:w-[350px] w-[200px] flex flex-row justify-center items-center border-[1px] h-[35px]  rounded-2xl border-solid border-customGreen'>
        <input
          className='pl-3 md:w-[300px] w-[160px] bg-transparent focus:outline-none focus:ring-0'
          placeholder='search...'
          type='text'
        />
        <FontAwesomeIcon
      ...
      <div className='flex justify-center items-center md:ml-[22vw]'>
        <div className='grid md:grid-cols-4 grid-cols-2 gap-3 md:gap-x-8'>
          <div className='border-[1px] hover:bg-slate-50 hover:rounded-2xl border-black border-solid bg-white flex flex-col justify-center items-center p-2 h-[auto] w-[45vw] md:w-[15vw]'>
            ...
            <button className='p-4 mb-3 hover:bg-slate-500 mt-4 flex justify-center items-center rounded-md bg-orange-500 text-white text-[0.8rem] w-[90%] h-3'>view product</button>
          </div>
