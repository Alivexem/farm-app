...
const Navprofile: React.FC<NavheadProps> = ({clicked}) => {
  return (
    ...
    <div className='absolute top-[0] left-0 h-[100vh] p-5 w-[70vw] bg-blue-900 border-none break-words' style={{display: clicked? 'block' : 'none'}}>
      <div className='flex gap-x-5 mt-[25%]'>
        <Image src='treadmill.webp' className='h-[75px] w-[80px] md:w-[70px] border-solid border-2 border-white rounded-[10px]' alt='image'/>
